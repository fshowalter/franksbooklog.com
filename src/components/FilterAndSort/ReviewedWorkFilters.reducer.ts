 ...
 */
export const SHOW_COUNT_INCREMENT = 100;

/**
 * Work-specific action types
 */
export enum ReviewedWorkFiltersActions {
 ...
 */
export function handleSetGradePendingFilterAction<
  TValue extends FilterableReviewedWork,
  TSort,
  TState extends ReviewedWorkFiltersState<TValue, TSort>,
 ...
 */
export function handleSetReviewYearPendingFilterAction<
  TValue extends FilterableReviewedWork,
  TSort,
  TState extends ReviewedWorkFiltersState<TValue, TSort>,
