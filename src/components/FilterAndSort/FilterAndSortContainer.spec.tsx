...
describe("ListWithFilters", () => {
  ...
  it("displays the correct total count", ({ expect }) => {
    ...
    expect(screen.getByText("View 250 Results")).toBeInTheDocument();
  });
  ...
  it("can sort items", async ({ expect }) => {
    ...
    render(<FilterAndSortContainer {...props}>Test</FilterAndSortContainer>);
  ...
  it("renders optional list header buttons", ({ expect }) => {
    ...
    render(
      <FilterAndSortContainer {...mockProps} headerLinks={headerLinks}>
        Test
