 ...
 */
export enum WorkFiltersActions {
 ...
 */
export function handleSetKindPendingFilterAction<
  TValue extends FilterableWork,
  TSort,
  TState extends WorkFiltersState<TValue, TSort>,
 ...
 */
export function handleSetTitlePendingFilterAction<
  TValue extends FilterableWork,
  TSort,
  TState extends WorkFiltersState<TValue, TSort>,
 ...
 */
export function handleSetWorkYearPendingFilterAction<
  TValue extends FilterableWork,
  TSort,
  TState extends WorkFiltersState<TValue, TSort>,
